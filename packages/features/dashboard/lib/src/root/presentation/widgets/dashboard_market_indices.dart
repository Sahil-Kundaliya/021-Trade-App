...
class DashboardMarketIndices extends StatefulWidget {
  const DashboardMarketIndices({super.key});

  @override
  State<DashboardMarketIndices> createState() => _DashboardMarketIndicesState();
}

class _DashboardMarketIndicesState extends State<DashboardMarketIndices> {
